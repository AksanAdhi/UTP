...
//    cout << endl << endl;
	...
	cout <<endl;
	cout << "Biasa (B)  \t\t  50k \t\t  50k \t\t\t  50k \t\t  50k \t\t  50k \t\t  75k \t\t   75k  " <<endl;
	cout <<endl;
	cout << "VIP (V) \t\t  90k \t\t  90k \t\t\t  90k \t\t  90k \t\t  90k \t\t  100k \t\t   100k  " <<endl;
	cout <<endl;
	cout << "Sweetbox (S)\t\t  90k \t\t  90k \t\t\t  90k \t\t  90k \t\t  90k \t\t  100k \t\t   100k  " <<endl;
	cout << endl;
	cout << endl;
	cout << "|====================================================================================================================================|" << endl;
	cout << endl;
